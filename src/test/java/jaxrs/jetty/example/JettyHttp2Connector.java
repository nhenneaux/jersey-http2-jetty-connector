 ...
 */
class JettyHttp2Connector implements Connector {

    private static final Logger LOGGER = Logger.getLogger(JettyHttp2Connector.class.getName());
     ...
     */
    JettyHttp2Connector(final Client jaxrsClient, final Configuration config) {
